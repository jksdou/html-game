...
var _config = {
    ...
    shareData = {
        imgUrl: "http://localhost:8080/games/se/assets/img/find.logo.png",
        timeLineLink: "http://localhost:8080/games/se/",
        tTitle: "看你有多色？",
        tContent: "找出所有色块中颜色不同的一块。分享朋友圈，找到身边的色魔，关注游戏中心:158369_weixin"
    };
! function() {
    var a = $("#box"),
        b = {
