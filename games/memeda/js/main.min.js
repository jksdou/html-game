...
shareData = {
	imgUrl: "http://localhost:8080/games/memeda/logo.png",
	timeLineLink: "http://localhost:8080/games/memeda/index.html",
	tTitle: "show girl 么么哒",
	tContent: "爱我你就吻我吧"
},
Res = ["http://localhost:8080/games/memeda/img/1.jpg", "http://localhost:8080/games/memeda/img/2.jpg", "http://localhost:8080/games/memeda/img/3.jpg", "http://localhost:8080/games/memeda/img/4.jpg", "http://localhost:8080/games/memeda/img/5.jpg", "http://localhost:8080/games/memeda/img/6.jpg", "http://localhost:8080/games/memeda/img/7.jpg", "http://localhost:8080/games/memeda/img/8.jpg", "http://localhost:8080/games/memeda/img/9.jpg", "http://localhost:8080/games/memeda/img/10.jpg", "http://localhost:8080/games/memeda/img/11.jpg", "http://localhost:8080/games/memeda/img/12.jpg", "http://localhost:8080/games/memeda/img/13.jpg", "http://localhost:8080/games/memeda/img/14.jpg", "http://localhost:8080/games/memeda/img/15.jpg", "http://localhost:8080/games/memeda/img/80.png", "http://localhost:8080/games/memeda/img/460.png"],
timeoutData = [{
	max: 30,
...
function(a) {
	...
	m = {
		...
		initShareEvent: function() {
			...
			function() {
				...
				function() {
					...
					function() {document.location.href = "http://localhost:8080/";})
		...
		kiss: function(a, b) {
			var c = $(f[a]),
			d = '<img src="http://localhost:8080/games/memeda/img/460.png" />';
			c.html(d),
